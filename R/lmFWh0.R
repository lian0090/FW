lmFWh0=function(y,VAR,ENV,VARlevels=NULL,ENVlevels=NULL){
  ...
  var_e=(summary(lm1)$sigma)^2
  LSvalue=list(y=y, whichNa = which(is.na(y)), VAR = VAR, ENV = ENV, VARlevels = VARlevels, ENVlevels = ENVlevels, mu = 0, g = g, b = b, h = h, yhat = yhat,var_e=var_e) 
